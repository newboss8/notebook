...
this: 
确保你使用的turbolinks 1.3.0 +，和使用这
(explained [here](https://github.com/rstacruz/nprogress/issues/8#issuecomment-23010560))
 ...
 * Add progress to your Ajax calls! Bind it to the jQuery `ajaxStart` and
 `ajaxStop` events.
 添加进步你的Ajax调用！绑定到jQuery ` ajaxstart `和
...
number between `0..1`.
__percentages：__设置进度百分比，称`。组（n）`，其中×N×是
...
如果你想通过特定的值递增，你可以将这个参数传递给参数

~~~ js
NProgress.inc(0.2);    // This will get the current status value and adds 0.2 until status is 0.994
这将获得目前的状态值，并增加了0.2，直到状态为0.994
~~~
